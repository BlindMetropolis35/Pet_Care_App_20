package com.example.petcareapp20.mainhome.ui.personal.chatsupport.utils
    ...
    fun basicResponses(_message: String): String {
        ...
        return when {
            ...
            message.contains("solve") -> {
                val equation: String? = message.substringAfterLast("solve") + message.substringBeforeLast("solve")
                return try {
